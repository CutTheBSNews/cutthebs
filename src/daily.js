...
async function renderVideo(episode, audioPath) {
  ...
  filterStr += `drawtext=text="Here's what's actually going on.":fontcolor=0xe53e3e:fontsize=54:x=(w-text_w)/2:y=790:fontfile=/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf:enable='between(t,0,${introEnd.toFixed(1)})',`;
  ...
  filterStr += `drawtext=text="Don't watch the news.":fontcolor=white:fontsize=60:x=(w-text_w)/2:y=700:fontfile=/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf:enable='between(t,${outroStart.toFixed(1)},${audioDuration.toFixed(1)})',`;
